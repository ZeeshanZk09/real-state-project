  ...
  const properties = await Promise.all([
    ...
    prisma.property.create({
      data: {
        ...
        description: 'Stunning beachfront property with direct ocean access and private beach.',
        propdetails:
        ...
        heatingType: 'Central',
        heatingFuel: 'Electric',
        rooms: 'Living Room,Dining Room,Kitchen,Master Suite,Guest Suites,Media Room',
        indoorFeatures: 'Walk-in Closet,High Ceilings,Gourmet Kitchen,Wine Cellar',
    ...
    prisma.property.create({
      data: {
        ...
        description: 'Secluded mountain cabin with breathtaking views and modern amenities.',
        propdetails:
  ...
  await Promise.all([
    ...
    prisma.inquiry.create({
      data: {
        ...
        email: 'mike.johnson@example.com',
        phone: '555-0103',
        message: 'What are the HOA fees and what do they cover? Also, is there parking available?',
        status: 'read',
      },
    }),
    prisma.inquiry.create({
      data: {
        ...
        email: 'john.doe@example.com',
        phone: '555-0101',
        message: 'Is this property still available? I would like to make an offer.',
        status: 'unread',
      },
    }),
  ]);

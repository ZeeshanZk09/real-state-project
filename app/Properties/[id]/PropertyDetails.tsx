"use client";
import { Hammer, BadgeDollarSign, Ruler, House } from "lucide-react";
        ...
        >
          ...
          <section className="border-t border-b   border-gray-300">
            ...
            >
              ...
              <ChevronDown
                className={`ml-1 transition-transform ${showMore ? "rotate-180" : "rotate-0"}`}
                size={16}
              />
            </button>

            <div className="flex gap-2 py-2">
              |<p>Now on Zebotix WBAs</p>|<p>200 views</p>|<p>19 saves</p>
            </div>
            <ol className="py-2">

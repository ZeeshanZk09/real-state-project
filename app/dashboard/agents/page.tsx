...
import { Card, CardBody, CardHeader, Input, Button, Avatar, Chip } from '@nextui-org/react';
          ...
          <Card key={agent.id} className='p-4'>
            ...
            <CardBody className='pt-4 gap-3'>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-sm font-semibold text-green-600'>{agent.propertiesSold}</span>
              </div>
              ...
              <div className='pt-2 space-y-1 border-t border-gray-200 dark:border-gray-700'>
                ...
                <p className='text-xs text-gray-600 dark:text-gray-400'>📱 {agent.phone}</p>
              </div>
              ...
              <div className='flex gap-2 pt-2'>
                ...
                <Button color='default' variant='bordered' size='sm' className='flex-1'>
                  View Profile
                </Button>
              </div>
            </CardBody>

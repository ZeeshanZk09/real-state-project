  ...
  const menuData = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Advertise", href: "/" },
        { name: "Become a Lender Partner", href: "/" },
      ],
    },
    {
      title: "Subsidiaries",
      links: [
        { name: "Rent", href: "/faqs" },
        { name: "ApartmentGuide", href: "/" },
        { name: "Bay Equity Home Loans", href: "/" },
        { name: "Title Forward", href: "/" },
      ],
    },
  ];
      ...
      <footer className="w-full py-20 ">
        <div className="mx-auto max-w-7xl px-4  sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center lg:justify-between flex-col lg:flex-row pb-12 sm:-pt-2 sm:pb-2 gap-7 lg:gap-0 border-b border-gray-200">
            ...
            <a
              href="javascript:;"
              className=" hidden lg:flex items-center gap-2 py-4  px-7 rounded-full shadow-md font-semibold hover:shadow-2xl bg-[#4F46E5]"
            >
              Contact us
              <svg
                width="17"
          ...
          <div className="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
            {menuData.map((menu, index) => (
              <div key={index} className="block">
                <h4 className="text-lg font-medium mb-4 min-[500px]:mb-7 text-center min-[500px]:text-left">
                  {menu.title}
                </h4>
          ...
          <div className="block lg:max-w-md lg:py-6">
            ...
            <div className="lg:bg-gray-100 lg:rounded-full pb-4 lg:h-16   lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between">
              ...
              <button
                type="submit"
                className="py-3.5 px-7   bg-indigo-600 shadow-md rounded-full font-semibold hover:bg-indigo-700"
              >
                Subscribe
              </button>
            </div>
          ...
          <div className="py-9 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
              <span className="text-sm">
                ©<a href="https://pagedone.io/">Zebotix WBAs</a> 2025, All
                rights reserved.
              </span>

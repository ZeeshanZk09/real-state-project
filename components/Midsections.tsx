        ...
        <div className='container mx-auto text-center'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div className='  border-solid border-2 shadow-2xl rounded-lg p-6 flex flex-col items-center text-center'>
              ...
              <p className=' mb-6'>
                Redfin agents are among the most experienced in the industry and can help you win in
                today’s market.
              </p>
              <a
                href='#find-agent'
            ...
            <div className='border-solid border-2 shadow-2xl rounded-lg p-6 flex flex-col items-center text-center'>
              ...
              <p className=' mb-6'>
                We know how to price, market, and sell your home for top dollar. And we do it all
                for half the listing fee others often charge.
              </p>
              <a
                href='#learn-more'
            ...
            <div className='border-solid border-2 shadow-2xl rounded-lg p-6 flex flex-col items-center text-center'>
              ...
              <p className=' mb-6'>
                Whether you’re searching for apartments, condos, or rental homes, we make it easy to
      ...
      >
        ...
        <div className='container mx-auto flex flex-col lg:flex-row items-center justify-between gap-8'>
          ...
          <div className='text-center lg:text-left lg:w-1/2'>
            ...
            <p className=' mb-6'>
              Unlike many other agents, Redfin agents won't ask you to sign an exclusive commitment
              before they'll take you on a first tour.
            </p>
            <a
              href='#search-homes'
              className='bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-300'
        ...
        <div className='container mx-auto flex flex-col lg:flex-row items-center justify-between gap-8'>
          ...
          <div className='lg:w-1/2 w-full'>
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <div>
                <label htmlFor='helpWith' className='block text-sm font-semibold  mb-2'>
